...
## 💡 Qu'est-ce que c'est ?
Le ROI Simple mesure le rendement en pourcentage absolu généré par un investissement par rapport à son coût, sans tenir compte du temps écoulé ou des flux de trésorerie de manière complexe. 
...
## 🎯 Quand l'utiliser
- Pour évaluer une **seule position** (ex: « Quel est mon gain sur mes actions Apple ? »).
