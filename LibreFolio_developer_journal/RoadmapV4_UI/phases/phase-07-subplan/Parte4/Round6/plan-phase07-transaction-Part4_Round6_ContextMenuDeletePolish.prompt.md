...
| **Piano D** — Split/Promote full stack | 10 → 11 → 12 | Backend batch integration → BulkModal UI → Main Table + suggest | ~5-6d | [`PlanD_SplitPromoteFullStack`](./../../../../plan-phase07-PlanD_SplitPromoteFullStack.prompt.md) |
