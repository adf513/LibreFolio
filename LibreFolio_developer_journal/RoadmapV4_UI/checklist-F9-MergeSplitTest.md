...
Data: 2026-03-31  
Stato: DA COMPLETARE dopo fix layout

---

## Setup Prerequisiti
- [ ] Navigare alla pagina asset con provider `Scheduled Investment`
- [ ] Verificare che l'editor tabellare appaia correttamente
...
| 7.3 | Modificare grace days nel popover | Valore aggiornato nel display "(+Nd grace → ∞)" |  |
...
| 9.4 | Toolbar bulk appare inline accanto a "Add Period" | Stessa riga |  |
