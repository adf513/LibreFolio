...
const NORTH_AMERICA = ['USA', 'CAN', 'MEX', 'BLZ', 'CRI', 'SLV', 'GTM', 'HND', 'NIC', 'PAN', 'ATG', 'BHS', 'BRB', 'CUB', 'DMA', 'DOM', 'GRD', 'HTI', 'JAM', 'KNA', 'LCA', 'VCT', 'TTO', 'ABW', 'CUW', 'SXM', 'BMU', 'CYM', 'TCA', 'VGB', 'VIR', 'PRI', 'GLP', 'MTQ', 'BLM', 'MAF'];
