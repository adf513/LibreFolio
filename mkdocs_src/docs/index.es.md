...
<div class="premium-landing">
 ...
 <div class="lf-quick-install-docker" style="display: block; padding: 2rem;">
  ...
  <p>Sigue nuestro progreso y recibe notificaciones de novedades:</p>
  <ul style="margin: 0.5rem 0 0; padding-left: 1.25rem; font-size: clamp(0.8rem, 2.5vw, 0.9rem); color: var(--md-default-fg-color--light);">
    <li>Haz clic en <strong>Watch</strong> al inicio del repositorio en GitHub.</li>
    <li>Selecciona <strong>Custom</strong> en el menú desplegable.</li>
    <li>Marca <strong>Releases</strong> y haz clic en <strong>Apply</strong>.</li>
  </ul>
  </div>
