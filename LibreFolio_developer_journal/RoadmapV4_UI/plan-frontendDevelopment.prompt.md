...
**Rationale**: Il frontend auth (Phase 1.4) è pronto MA gli endpoint backend NON esistono. **Senza backend auth, il login non può funzionare!** Questa fase implementa l'intero sistema di autenticazione lato server PRIMA di procedere con il resto del frontend.
