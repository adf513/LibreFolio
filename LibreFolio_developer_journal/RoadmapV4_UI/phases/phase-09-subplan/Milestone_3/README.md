...
| 2 | [`plan_ui_broker_holdings.md`](./plan_ui_broker_holdings.md) | Tab Posizioni (riuso `PositionsPanel`) + Pannello Inline Lotti FIFO multi-broker (bubble timeline + WAC/prezzo per-broker+combinato) | [`../plan_ui_broker_holdings.md`](../plan_ui_broker_holdings.md) | ✅ disegno raffinato · ✅ [piano implementativo](./impl_plan_broker_holdings.md) · ✅ implementato (2026-07-10) · ✅ evoluto multi-broker (2026-07-11, fleet — codice committato) |
| 3 | [`plan_ui_broker_transactions.md`](./plan_ui_broker_transactions.md) | Tab Transazioni (riuso `<TransactionsTable>`) + File Importati | [`../plan_ui_broker_transactions.md`](../plan_ui_broker_transactions.md) | ✅ disegno · ✅ implementato (recap in-doc, nessun `impl_plan_*.md` separato — chiuso 2026-07-08, codice committato) |
...
| File | Descrizione |
|------|-------------|
| [`GUIDA-TOOLBAR-RESPONSIVE-v2.md`](./GUIDA-TOOLBAR-RESPONSIVE-v2.md) | ✅ Come tarare le soglie responsive (`PageToolbar`/`DateRangePicker`) — soglie per pagina, badge "jolly" auto-fit, tuning live da console browser (`window.__lfLayouts`), checklist per estendere il sistema a una nuova pagina |

## Piano principale

→ [`../../phase-09-dashboard.md`](../../phase-09-dashboard.md) — Macro plan ufficiale di
Phase 9.
