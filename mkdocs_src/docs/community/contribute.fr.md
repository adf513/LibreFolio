...
## :bulb: Partagez vos Idées et Signalez les Bugs

Vos retours façonnent l'avenir de LibreFolio :

- :bug: **Signalez des bugs** sur [GitHub Issues](https://github.com/Alfystar/LibreFolio/issues)
- :sparkles: **Suggérez des fonctionnalités** via [GitHub Discussions](https://github.com/Alfystar/LibreFolio/discussions)
