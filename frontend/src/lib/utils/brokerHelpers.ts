 ...
 *
 * Centralizes the icon_url → portal_url/favicon.ico → null fallback chain
 * previously duplicated across FilesTable, TransactionsTable, BrokerBadge, etc.
 *
 ...
 *  3. `null` (caller should render a colored dot or other fallback)
 */
