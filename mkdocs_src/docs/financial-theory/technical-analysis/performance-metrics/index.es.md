...
* **Limitaciones:** No tiene en cuenta *cuándo* se produjeron los flujos de caja, lo que provoca la dilución del ROI al realizar compras posteriores del mismo activo.

### 2. [TWRR (Tasa de Retorno Ponderada por el Tiempo)](twrr.md)
...
### 3. [MWRR Anualizado (Tasa de Retorno Ponderada por el Dinero)](mwrr.md#mwrr-anualizado)
...
### 4. [MWRR Acumulado](mwrr.md#mwrr-acumulado)
