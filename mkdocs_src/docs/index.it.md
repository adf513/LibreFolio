...
hide:
 - navigation
 - toc
description: Riconquista la proprietà dei tuoi dati finanziari. LibreFolio è la dashboard di investimento incentrata sulla privacy, auto-ospitata, per l'intero tuo portafoglio.
---
...
<div class="home-header">
 ...
 <div class="home-logo">
 <img src="../static/logo.png" alt="Logo di LibreFolio"/>
 </div>
 ...
 <h1>LibreFolio</h1>
 <h2><strong>La tua ricchezza, le tue regole.</strong></h2>
 <p class="mission">
 Vivi la libertà della vera sovranità finanziaria.
 <br>
 Porta tutti i tuoi asset in un'unica dashboard sicura e auto-ospitata.
 <br><br>
 Controllo completo, zero compromessi.
 </p>

 <div class="asset-icons">
 <a href="financial-theory/asset-types/" class="asset-icon-link">
 <div class="asset-icon" title="Azioni">
 <img src="../static/icons/asset-types/stock.png" alt="Azioni" />
 <span>Azioni</span>
 </div>
 </a>
 <a href="financial-theory/asset-types/" class="asset-icon-link">
 ...
 <a href="financial-theory/asset-types/" class="asset-icon-link">
 <div class="asset-icon" title="Cripto">
 <img src="../static/icons/asset-types/crypto.png" alt="Cripto" />
 <span>Cripto</span>
 </div>
 </a>
 <a href="financial-theory/asset-types/" class="asset-icon-link">
 <div class="asset-icon" title="Obbligazioni">
 <img src="../static/icons/asset-types/bond.png" alt="Obbligazioni" />
 <span>Obbligazioni</span>
 </div>
 </a>
 <a href="financial-theory/asset-types/" class="asset-icon-link">
 <div class="asset-icon" title="Prestiti P2P">
 <img src="../static/icons/asset-types/crowdfunding.png" alt="P2P" />
 <span>P2P</span>
 </div>
 </a>
 <a href="financial-theory/asset-types/" class="asset-icon-link">
 <div class="asset-icon" title="Fondi">
 <img src="../static/icons/asset-types/fund.png" alt="Fondi" />
 <span>Fondi</span>
 </div>
 </a>
 <a href="financial-theory/asset-types/" class="asset-icon-link">
 <div class="asset-icon" title="Materie prime">
 <img src="../static/icons/asset-types/hold.png" alt="Materie prime" />
 <span>Materie prime</span>
 </div>
 </a>
 <a href="financial-theory/asset-types/" class="asset-icon-link">
 <div class="asset-icon" title="Altro">
 <img src="../static/icons/asset-types/other.png" alt="Altro" />
 <span>Altro</span>
 </div>
 </a>
 </div>
...
<div class="grid cards">
 ...
 <span class="card-title">Per iniziare</span>
 ...
 <span class="card-desc">Architettura,<br>riferimento API e guida per contribuire.</span>
 </div>
 </a>
 ...
 <div class="card-content">
 <span class="card-title">Note legali e crediti</span>
 <span class="card-desc">Licenza (AGPL-3.0),<br>membri del team e riconoscimenti.</span>
 </div>
 </a>
