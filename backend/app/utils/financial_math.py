...
def calculate_day_count_fraction(
    ...
    - ACT/ACT: Actual days / actual days in year (365 or 366)
...
# TODO: rimuovere a mano questa funzione quando quelle sopra saranno state integrate ovunque
...
def calculate_daily_factor_between_act365(start_date: date_type, end_date: date_type) -> Decimal:
    ...
    DEPRECATED: Use calculate_day_count_fraction() with DayCountConvention.ACT_365 instead.
...
# TODO: rimuovere a mano questa funzione quando quella sopra sarà stata integrata ovunque
def find_active_rate(
    ...
    """
    Find and return the annual interest rate for target date.

    DEPRECATED: Use find_active_period() to get full period details including
    compounding type, frequency, and day count convention.
    ...
    """
    period = find_active_period(schedule, target_date, maturity_date, late_interest)
    return period.annual_rate if period else Decimal("0")
