...
## 💡 Cos'è?
Il ROI Semplice misura il rendimento percentuale assoluto generato da un investimento rispetto al suo costo, senza considerare il tempo trascorso o i flussi di cassa in modo complesso. 
...
## 🎯 Quando usarlo
- Per valutare una **singola posizione** (es. "Quanto sono in guadagno sulle mie azioni Apple?").
