...
* 📥 **Importación de Bróker Muy Sencilla**: ¡No necesita escribir todo a mano! LibreFolio le permite cargar exportaciones en CSV o PDF de su bróker y mapearlas e importarlas automáticamente en segundos. Obtenga más información en la guía de **[Importación desde Bróker](import/index.md)**.
...
|---------|-------------|-----------|
| **Añadir y Editar** | Haga clic en **+ Nueva Transacción** para abrir el formulario, o haga clic en cualquier fila existente para editar sus detalles. | [Formulario de Transacción](form.md) |
